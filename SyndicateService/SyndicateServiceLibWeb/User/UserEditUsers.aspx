<%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMain.master" AutoEventWireup="true" CodeBehind="UserEditUsers.aspx.cs" Inherits="SyndicateServiceLibWeb.Import.UserEditUsers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <dx:ASPxGridView ID="ASPxGridViewMain" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceMain" KeyFieldName="user_id" EnableTheming="True" Theme="Moderno" Width="100%">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="user_pass" VisibleIndex="3" Caption="Password" PropertiesTextEdit-Password="True">
            </dx:GridViewDataTextColumn>
