...
{
    public class ReprintWarasaVm : ViewModelBase
    {
        ...
        public ReprintWarasaVm(INavigationService navigationService)
        {
        ...
        public async void Execute()
        {
            ...
            try
            {
                ...
                string result = await srv.GetReprintWarasaAsync(_id, UserManager.CurrentUser.user_id.ToString(), _type.Reprintresonid.ToString());
                if (result == null)
                {
