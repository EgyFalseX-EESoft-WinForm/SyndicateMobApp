...
{
    public class WarasaActivateVisaVm : ViewModelBase
    {
        ...
        public WarasaActivateVisaVm(INavigationService navigationService)
        {
        ...
        public async void Execute()
        {
            ...
            try
            {
                string result = await srv.ActivateWarasaVisaAsync(_id);
                if (result == null)
                {
